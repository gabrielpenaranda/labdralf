...
@section('content')
    <div class="container">
        ...
        <div class="row">
            <div class="col-xs-2">
                <a class="btn btn-primary" href="{{ route('facturas.create', ['modulo' => $modulo]) }}">Crear Factura</a>
                <br>
            </div>
        </div>
        <div class="row">
                                    ...
                                    <td class="text-center">
                                        @if (Auth::check())
                                            {{-- <form action="{{ route('facturas.destroy', ['factura' => $f->id]) }}" method='POST'>
                                                ...
                                                <a class="btn btn-warning btn-sm" href="{{ route('facturas.show', ['factura' => $f->id, 'modulo' => $modulo]) }}" title="Ver factura"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
