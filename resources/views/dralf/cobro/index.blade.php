                                    ...
                                    <td class="text-center">
                                        @if (Auth::check())
                                            {{-- <form action="{{ route('facturas.destroy', ['factura' => $f->id]) }}" method='POST'>
                                                ...
                                                <a class="btn btn-info btn-sm" href="{{ route('cobros.create', ['factura' => $f->id, 'modulo' => $modulo]) }}" title="Agregar pagos"><span class="glyphicon glyphicon-plus" aria-hidden="true"></span></a>
                                                <a class="btn btn-warning btn-sm" href="{{ route('cobros.show', ['factura' => $f->id, 'modulo' => $modulo]) }}" title="Ver pagos"><span class="glyphicon glyphicon-eye-open" aria-hidden="true"></span></a>
                                            {{-- </form> --}}
                                        @endif
                                    </td>
                                </tr>
